...
package com.example.musicplayee.view
...
import com.example.musicplayee.JcPlayerManager
import com.example.musicplayee.JcPlayerManagerListener
import com.example.musicplayee.R
import com.example.musicplayee.general.JcStatus
import com.example.musicplayee.general.PlayerUtil.toTimeSongString
import com.example.musicplayee.general.errors.AudioListNullPointerException
import com.example.musicplayee.general.errors.OnInvalidPathListener
...
class JcPlayerView : LinearLayout, View.OnClickListener, SeekBar.OnSeekBarChangeListener, JcPlayerManagerListener {
    ...
    private fun init() {
        ...
        inflate(context, R.layout.view_jcplayer, this)
