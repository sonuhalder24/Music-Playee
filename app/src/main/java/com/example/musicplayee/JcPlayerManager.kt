...
import com.example.musicplayee.general.errors.JcpServiceDisconnectedError
import com.example.musicplayee.model.JcAudio
import com.example.musicplayee.service.JcPlayerService
...
import com.example.musicplayee.service.notification.JcNotificationPlayer
...
private constructor(private val serviceConnection: JcServiceConnection) : JcPlayerServiceListener {
    ...
    var jcPlayerService: JcPlayerService? = null
